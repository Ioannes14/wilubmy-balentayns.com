...
const blackmail = [
  "opss taym sa (e yes please)",
  "tarunga og pindot ang yes",
  "cge dawat na nako (e yes btaw oy)",
  "HUHUHUHU 😭😭😭",
  "hangyu nani please say yes na",
  "maluoy ka nako HUHU",
  "e yes para happy ta duha",
  "e yes btaw dika mag mahay",
  "nah dijud ta mag human ani 😔",
];
...
function yes() {
  if (counter >= 3) {
    ...
    wedate.innerText = "February 14, 4:00 p.m. CTU DANAO, Ice Cream Date";
  } else {
    alert("ayiee ni yes dayun siya HAHAHHA pag pindot2x sa saNO");
  }
}
